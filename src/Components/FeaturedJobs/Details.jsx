...
function Details({ job }) {
     ...
     return (
          <div className="flex justify-between border px-3 bg-base-100">
               <div className="flex gap-4 ">
                    <div className="max-w-[200px] ml-6 mt-6 flex items-center rounded-lg">
                         <div className='bg-gray-300 h-24 flex items-center justify-center w-[150px]'><img className="max-w-[100px]" src={job.logo} alt="Shoes" /></div>
                    </div>
                    <div className="card-body">
                         <h2 className="card-title">{job.job_title}</h2>
                         <p>{job.company_name}</p>
                         <div className="flex gap-3">
                              <button className="border border-red-200 px-4 py-2">{job.remote_or_onsite}</button>
                              <button className="border border-red-200 px-4 py-2">{job.job_type}</button>
                         </div>
