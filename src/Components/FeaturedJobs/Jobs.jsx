...
function Jobs({ job }) {
     return (
          ...
          <div className="card pl-6 border bg-base-100 ">
               <div className="max-w-[200px] ml-6 mt-6 rounded-lg">
                    <img className="" src={job.logo} alt="Shoes" /></div>
               <div className="card-body">
                    ...
                    <Link to={`/details/${job.id}`} state={job.job_title}><button className="btn text-white bg-gradient-to-r from-[#7E90FE] to-[#9873FF]">View Details</button></Link>
               </div>
          </div>
